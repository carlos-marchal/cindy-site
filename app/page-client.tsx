...
import { SiteSettings, SiteSettingsNavigation } from '@/sanity-client/config'
...
const Circle = () => {
  ...
  useEffect(() => {
    ...
    return () => window.document.body.removeEventListener('mousemove', listener)
  }, [translateXRaw, translateYRaw])
